...
def construct_society(question: str) -> RolePlaying:
    ...
    models = {
        "user": ModelFactory.create(
            ...
            model_config_dict={"temperature": 0.4, "max_tokens": 128000, "function_call": "auto"},
        ),
    ...
    assistant_agent_kwargs = {"model": models["assistant"]}  # Remove tools to disable function calling
